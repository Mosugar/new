(function (e) {
  ...
  var A = {
      getVendorConsents: function (a) {
        ...
        if ("B" === g[0]) {
          ...
          (q = k.substr(152, 24)),
            (k = (e.b64toint(g.substr(35, 4)) & 2097151) >> 5);
        d = e.extendObj(
          {},
          f,
          p(((d || {}).TcfV1Consent || {}).VendorIds),
          p((b || {}).VendorConsent)
        );
        if (a && a.length)
        ...
        return [
          {
            metadata: g.substr(0, 18) + g.substr(20, 2),
            gdprApplies: !!c,
            hasGlobalScope: !1,
            purposeConsents: m,
            vendorConsents: l,
      ...
      getConsentData: function (a) {
        ...
        return [
          {
            consentData:
              a.euconsent || ((d.sections || {}).tcfeuv2 || {}).str || "",
            gdprApplies: !!c,
            hasGlobalScope: !1,
          },
          !0,
      ...
      ping: function () {
        ...
        return [
          { gdprAppliesGlobally: !1, cmpLoaded: !(!a.euconsent && !c.str) },
          !0,
        ];
      },
    },
    ...
    t = {
      getTCData: function (a) {
        var c = l(e._global("__adroll_consent_is_gdpr")),
          ...
          b = ((e._global("__adroll_consent_gpp") || {}).sections || {})
            .tcfeuv2,
          f = d.eucookie,
          g = (f || {}).publisher_tc || {},
          k = {
            ...
            purpose: {},
            vendor: {},
            publisher: { customPurpose: {} },
          };
        f
          ? ((k = 130 === f.cmp_id ? 54 : f.cmp_id),
            (k = {
              ...
              vendor: {
                ...
                legitimateInterests: v(f.vendor_legitimate_interest, a),
              },
              ...
              publisher: {
                ...
                customPurpose: {
                  ...
                  legitimateInterests: n(
                    g.custom_purposes_li_transparency,
                    g.num_custom_purposes
                  ),
                },
          ...
          : b &&
            ...
            (k = {
              ...
              publisher: { restrictions: w(b.PublisherRestrictions) },
            }));
        return [k, !0];
      },
      ping: function () {
      ...
      _triggerEvent: function (a) {
        ...
        null === g.arconsent || "banner" === k.state
          ? (f = "cmpuishown")
          : r && (f = "useractioncomplete");
        b.cmpId || ((b.cmpId = 54), (b.cmpVersion = 1), (b.gvlVersion = 41));
        d && 2 === d.length
          ? ((b.eventStatus = f), (b.listenerId = a), c(b, d[1]))
          : c({}, !1);
        "banner" === k.state && (r = !0);
      },
    },
    ...
    u = {
      ping: function () {
        ...
        f.str &&
          f.header &&
          f.sections &&
          ((d = "ready"), (b = f.header.Sections));
        e._global("__adroll_consent_is_gdpr") && (c = [2]);
        var g = "hidden";
        "banner" === (e._global("__adroll_consent_banner") || {}).state &&
          (g = "visible");
        return {
          gppVersion: "1.1",
          cmpStatus: a,
      ...
      _triggerEvents: function (a) {
        ...
        var f = e._global("__adroll_consent_banner") || {},
          g = u.ping();
        null === b.arconsent || "banner" === f.state
          ? d.push(
        ...
        for (b = 0; b < d.length; b++)
          c(
            { eventName: d[b][0], listenerId: a, data: d[b][1], pingData: g },
            !0
          );
        "banner" === f.state && (r = !0);
      },
  ...
  e._install_cmp = function () {
    ...
    a = e._tcfapi_calls || [];
    e._tcfapi_calls = [];
    for (c = 0; c < a.length; c++) e._global("__tcfapi").apply(e, a[c]);
  ...
  (function () {
    if (
      e._has_global("__cmp") ||
      e._has_global("__gpp") ||
      (e._has_global("__tcfapi") &&
        !e._has_global("_adroll_tcfapi_placeholder_installed"))
    )
      e._install_cmp = function () {};
    else {
      e._cmp_calls = [];
      e._set_global("__cmp", function (a, d, b) {
        "ping" === a
          ? b({ gdprAppliesGlobally: !1, cmpLoaded: !1 })
      ...
      e._set_global("__tcfapi", function (a, d, b, f) {
        "ping" === a
          ...
          : e._tcfapi_calls.push([a, d, b, f]);
      });
      window.addEventListener(
        "message",
        function (a) {
          try {
            var c = "string" === typeof a.data ? e.jsonParse(a.data) : a.data;
          } catch (f) {}
          var b = (c || {}).__tcfapiCall;
          (b || {}).command &&
            e._global("__tcfapi").call(
              this,
              b.command,
              b.version,
              function (c, d) {
      ...
      a.style =
        "width:0; height:0; border:0; padding:0; visibility:hidden; position:absolute; margin:0 0 0 -1000px;";
